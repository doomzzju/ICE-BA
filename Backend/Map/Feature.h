...
inline void GetFactor(const float w, const Rigid3D *T12, const Source &x1,
                      ...
                      const Measurement &z2, LINEARIZATION *L, FACTOR *A, const float r2Max = FLT_MAX) {
...
inline void GetFactor(const float w, const Rigid3D *T12, const Source &x1,
                      const Depth::InverseGaussian &d1, const Rigid3D &T2,
                      const Measurement &z2, Factor::Depth *A, Factor::Depth::U *U, const float r2Max = FLT_MAX) {
  GetFactor<ME_FUNCTION, Factor::Depth, Factor::Depth::U>(w, T12, x1, d1, T2, z2, A, U, r2Max);
  A->m_add = U->m_A;
}
template<int ME_FUNCTION>
inline void GetFactor(const float w, const Rigid3D *T12, const Source &x1,
                      ...
                      Factor::FixSource::U *U, const float r2Max = FLT_MAX) {
  GetFactor<ME_FUNCTION, Factor::FixSource::L, Factor::FixSource::U>(w, T12, x1, d1, T2, z2, L, U, r2Max);
...
inline void GetFactor(const float w, const Rigid3D *T12, const Source &x1,
                      ...
                      Factor::Full::A2 *A2, Factor::Full::U *U, const float r2Max = FLT_MAX) {
  GetFactor<ME_FUNCTION, Factor::Full::L, Factor::Full::U>(w, T12, x1, d1, T2, z2, L, U, r2Max);
